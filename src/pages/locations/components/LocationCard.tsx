...
import { formatCreatedDate } from '../locations-utils'

interface LocationCardProps {
  location: AirtableRecord<LocationFields>
  isSelected: boolean
  isToggling: boolean
      ...
      <CardContent className="pt-0 px-6 pb-6">
        <div className="flex items-center justify-between mb-4 pt-4 border-t border-border">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              onClick={(e) => {
                e.stopPropagation()
                onToggleActive(location.id, location.fields.Status ?? "Active")
              }}
              disabled={isToggling}
        ...
        <div className="flex items-center gap-2 text-muted-foreground">
          ...
          <span className="text-xs">
            Created {formatCreatedDate(location.createdTime)}
          </span>
        </div>
      </CardContent>
    </Card>
