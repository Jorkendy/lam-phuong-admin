/**
 * Header component for Job Types page
 */

import { Button } from '@/components/ui/button'

interface JobTypesPageHeaderProps {
  selectedCount: number
  onDeleteClick: () => void
  onCreateClick: () => void
}

export function JobTypesPageHeader({ selectedCount, onDeleteClick, onCreateClick }: JobTypesPageHeaderProps) {
  return (
