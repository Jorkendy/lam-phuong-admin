/**
 * Header component for Product Groups page
 */

import { Button } from '@/components/ui/button'

interface ProductGroupsPageHeaderProps {
  selectedCount: number
  onDeleteClick: () => void
  onCreateClick: () => void
}

export function ProductGroupsPageHeader({ selectedCount, onDeleteClick, onCreateClick }: ProductGroupsPageHeaderProps) {
  return (
